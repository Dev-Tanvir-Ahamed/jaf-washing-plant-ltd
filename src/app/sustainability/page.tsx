...
const Sustainability = () => {
  return (
    <>
      <div
        className="h-[500px]   flex justify-center items-center flex-col mb-5 text-center"
        style={{
      ...
      >
        ...
        <div className="max-w-4xl text-white font-light text-[18px] space-y-3">
          <p className="mb-3">
            At Al-Madina Washing Plant Ltd., we are deeply committed to
            sustainability and environmental responsibility. We recognize the
            importance of protecting our planet and minimizing our ecological
            footprint. With this in mind, we have implemented various
            initiatives to promote sustainable practices throughout our
            operations.
          </p>
          <p>
